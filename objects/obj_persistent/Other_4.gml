...
if (room != rm_niveles_mundiales && room != rm_guardabot_play && room != rm_leaderboards)
{
...
if room == rm_editor or room == rm_title or room == rm_guardabot or room = rm_niveles_mundiales or room = rm_course_world or room == rm_credito or room = rm_leaderboards
{
	global.dsm = 0
}
/*
if (room == rm_title)
    ...
    else if (room == rm_course_world || room == rm_niveles_mundiales)
	{
		np_update();
