...
if (global.nm_play != 0)
{
    with (instance_create((camera_get_view_x(view_get_camera(0)) + 341), (camera_get_view_y(view_get_camera(0)) + 71), obj_nm_dislike_heart))
        depth = -17
    with (instance_create((camera_get_view_x(view_get_camera(0)) + 281), (camera_get_view_y(view_get_camera(0)) + 71), obj_nm_like_heart))
        depth = -17
    ...
    with (instance_create((camera_get_view_x(view_get_camera(0)) + 255), (camera_get_view_y(view_get_camera(0)) + 131), obj_pausa_button))
    {
		...
		if global.lives < 2 and global.dsm = 1{
			button_c = c_grey
			c_button = c_grey
		}
		else
    ...
    with (instance_create((camera_get_view_x(view_get_camera(0)) + 255), (camera_get_view_y(view_get_camera(0)) + 157), obj_pausa_button))
    {
		...
		if global.lives < 1 and global.dsm = 1{
			button_c = c_grey
			c_button = c_grey
		}
		else
