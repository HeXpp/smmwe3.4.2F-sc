...
if (type == 0 && instance_exists(obj_nivelesmundiales))
{
    ...
    draw_text((x - 8), (y - 22), string_hash_to_newline((scr_language(123))))
    draw_set_color(c_black)
    draw_set_halign(fa_center)
    if (obj_nivelesmundiales.orden == -1)
        var texto = scr_language(147)
    else
        texto = text[obj_nivelesmundiales.orden]
