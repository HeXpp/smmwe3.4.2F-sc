if (room == rm_editor && instance_exists(obj_levelmanager) && obj_levelmanager.editor == 1 && instance_exists(obj_editormanager) && scr_insideview() && obj_editormanager.zoom == 0 && (obj_editormanager.expand_open == 0 || obj_levelmanager.editor_sonidos == 1))
{
    if ((!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_parent_layout))) && (!(collision_rectangle((floor((mouse_x / 16)) * 16), (floor((mouse_y / 16)) * 16), ((floor((mouse_x / 16)) * 16) + 15), ((floor((mouse_y / 16)) * 16) + 15), obj_ground2, 1, 1))) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_ground2))) && (!(collision_rectangle((floor((mouse_x / 16)) * 16), (floor((mouse_y / 16)) * 16), ((floor((mouse_x / 16)) * 16) + 15), ((floor((mouse_y / 16)) * 16) + 15), obj_ground3, 1, 1))) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_ground3))))
    {
        ...
        {
            if (obj_persistent.modo_android == 1 && move_view == 0 && global.select_resource == obj_resource_empty && ((!(collision_rectangle((floor((mouse_x / 16)) * 16), (floor((mouse_y / 16)) * 16), ((floor((mouse_x / 16)) * 16) + 15), ((floor((mouse_y / 16)) * 16) + 15), obj_parent_resource, 1, 1))) || collision_rectangle((floor((mouse_x / 16)) * 16), (floor((mouse_y / 16)) * 16), ((floor((mouse_x / 16)) * 16) + 15), ((floor((mouse_y / 16)) * 16) + 15), obj_ground, 1, 1)) && ((!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_parent_resource))) || place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_ground)) && (!(collision_rectangle((floor((mouse_x / 16)) * 16), (floor((mouse_y / 16)) * 16), ((floor((mouse_x / 16)) * 16) + 15), ((floor((mouse_y / 16)) * 16) + 15), obj_mario_editor, 1, 1))) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_mario_editor))) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_expand_panels))) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_expand_panels_left))) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_expand_paneles_top))) && (!instance_exists(obj_apariencia)) && (!instance_exists(obj_bg_selection)) && (!instance_exists(obj_time)) && (!instance_exists(obj_autoavance)) && (!instance_exists(obj_condiciones)) && (!instance_exists(obj_edit_menu)) && (!instance_exists(obj_panel_save_load)) && (!instance_exists(obj_alert_load)) && (!instance_exists(obj_window_alert)) && (!instance_exists(obj_settings_panel)) && move_tuberia == 0 && global.cursor == 0)
                move_view = 1
        }
    }
}
