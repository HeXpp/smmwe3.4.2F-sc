...
else
{
    ...
    if (editor == 0)
    {
        if (global.bonus_music > 0)
        {
            ...
            {
                if (global.bonus_obj != obj_lighting && (!instance_exists(global.bonus_obj)) && global.ef_repeat == 0 && (!instance_exists(obj_superado_bg)) && (!instance_exists(obj_player_goal_parent)) && (!instance_exists(obj_deadmario)))
                {
        ...
        if (global.boss_music > 0)
        {
            ...
            {
                if (global.bowser_obj != obj_lighting && (!instance_exists(global.bowser_obj)) && global.ef_repeat == 0 && (!instance_exists(obj_superado_bg)) && (!instance_exists(obj_player_goal_parent)) && (!instance_exists(obj_deadmario)))
                {
                    audio_stop_sound(levelmusic)
                    switch global.powerup
                    {
