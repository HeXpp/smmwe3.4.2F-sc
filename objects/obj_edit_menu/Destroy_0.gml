...
if (instance_exists(obj_leaderboards) && (!instance_exists(obj_settings_panel)) && ((!instance_exists(obj_lb_button_retry)) || (instance_exists(obj_lb_button_retry) && obj_lb_button_retry.image_index == 0)))
{
