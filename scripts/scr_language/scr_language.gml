...
switch argument0
{
 ...
 case 201: return "¿Estás seguro de iniciar una nueva partida?#Perderás todo el progreso que hiciste.#¿Quieres Continuar?"
 }
}
...
switch argument0
{
 ...
 case 171: return "The special condition can no longer be met"
 ...
 case 201: return "Are you sure to start a new game?#You will lose all the progress you made.#Do you want to continue?"
 }
}
...
switch argument0
{
 ...
 case 201: return "Tem certeza de que quer iniciar uma nova partida?#Você perdera todo o progresso q fez.#Você quer continuar?"
}
}
...
switch argument0
{
  ...
  case 201: return "Sei sicuro di iniziare una nuova partita?#Perderai tutti i progressi fatti finora.#Vuoi continuare?"
  }
}
...
switch argument0
{
 ...
 case 201: return "您确定要开始新游戏吗？#你将失去你所取得的所有进展。#你想继续吗？"
 }
}
}